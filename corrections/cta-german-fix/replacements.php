<?php
/**
 * CTA German Fix — replacement map.
 * Source of truth: DB scan of backup-reference (finalmagicmoonbackup.wpress).
 * Ordered longest-first so longer phrases replace before their substrings.
 *
 * Original English texts are the KEYS (reference data, from backup).
 * German corrections are the VALUES (new code).
 */
